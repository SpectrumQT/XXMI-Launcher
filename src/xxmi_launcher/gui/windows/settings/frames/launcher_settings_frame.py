...
class LauncherSettingsFrame(UIScrollableFrame):
    def __init__(self, master):
        ...
        # Language
        self.put(LanguageLabel(self)).grid(row=3, column=0, padx=(20, 10), pady=(0, 30), sticky='w')
        self.put(LanguageOptionMenu(self)).grid(row=3, column=1, padx=10, pady=(0, 30), sticky='w')

        # Connection
        self.put(ConnectionLabel(self)).grid(row=4, column=0, padx=(20, 10), pady=(0, 30), sticky='w')
        self.put(ConnectionFrame(self)).grid(row=4, column=1, padx=10, pady=(0, 30), sticky='ew', columnspan=3)

        # Proxy
        self.put(ProxyEnableCheckbox(self)).grid(row=5, column=0, padx=(20, 10), pady=(0, 20), sticky='w')
        self.put(ProxySettingsFrame(self)).grid(row=5, column=1, padx=10, pady=(0, 20), sticky='w', columnspan=3)
        self.put(ProxyAddressFrame(self)).grid(row=6, column=1, padx=10, pady=(0, 20), sticky='w', columnspan=3)
        self.put(ProxyCredentialsFrame(self)).grid(row=7, column=1, padx=10, pady=(0, 20), sticky='w', columnspan=3)
...
class StartBehaviorLabel(UILabel):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_start_behavior_label', 'Start Behavior:')),
...
class AutoCloseCheckbox(UICheckbox):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_auto_close_checkbox', 'Close Launcher After Game Start')),
            variable=Vars.Launcher.auto_close,
            master=master)
        self.set_tooltip(str(L('launcher_settings_auto_close_tooltip', 
...
class TimeoutLabel(UILabel):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_timeout_label', 'Timeout:')),
...
class TimeoutEntry(UIEntry):
    def __init__(self, master):
        super().__init__(
            ...
            font=('Arial', 14),
            master=master)
        self.set_tooltip(str(L('launcher_settings_timeout_tooltip',
...
class UpdatePolicyLabel(UILabel):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_update_policy_label', 'Update Policy:')),
            font=('Microsoft YaHei', 14, 'bold'),
            fg_color='transparent',
            master=master)
...
class AutoUpdateCheckbox(UICheckbox):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_auto_update_checkbox', 'Auto Update')),
            variable=Vars.Launcher.auto_update,
            master=master)
        self.set_tooltip(self.get_tooltip)

    def get_tooltip(self):
        msg = str(L('launcher_settings_auto_update_tooltip_enabled', 'Enabled: Launcher and {importer} updates will be Downloaded and Installed automatically.').format(importer=Config.Launcher.active_importer)) + '\n'
        msg += str(L('launcher_settings_auto_update_tooltip_disabled', 'Disabled: Use special [▲] button next to [Start] button to Download and Install updates manually.'))
        return msg.strip()
...
class UpdateChannelLabel(UILabel):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_update_channel_label', 'Channel:')),
            font=('Microsoft YaHei', 14),
            fg_color='transparent',
            master=master)
...
class UpdateChannelOptionMenu(UIOptionMenu):
    def __init__(self, master):
        super().__init__(
            ...
            master=master)
        self.set_tooltip(str(L('launcher_settings_update_channel_tooltip',
...
class ThemeLabel(UILabel):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_theme_label', 'UI Theme:')),
            font=('Microsoft YaHei', 14, 'bold'),
            fg_color='transparent',
            master=master)
...
class LauncherThemeOptionMenu(UIOptionMenu):
    def __init__(self, master):
        super().__init__(
            ...
            dropdown_font=('Arial', 14),
            master=master)
        self.set_tooltip(str(L('launcher_settings_theme_tooltip',
...
class ApplyThemeButton(UIButton):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_apply_theme_button', '⟲ Apply')),
...
class EnableDevMode(UICheckbox):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_dev_mode_checkbox', 'Dev Mode')),
            variable=Vars.Launcher.theme_dev_mode,
            master=master)
        self.set_tooltip(str(L('launcher_settings_dev_mode_tooltip',
...
class ConnectionLabel(UILabel):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_connection_label', 'Connection:')),
            font=('Microsoft YaHei', 14, 'bold'),
            fg_color='transparent',
            master=master)
...
class GitHubTokenLabel(UILabel):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_github_token_label', 'GitHub Token:')),
            font=('Microsoft YaHei', 14),
            fg_color='transparent',
            master=master)
...
class GitHubTokenEntry(UIEntry):
    def __init__(self, master):
        super().__init__(
            ...
            font=('Arial', 14),
            master=master)
        self.set_tooltip(str(L('launcher_settings_github_token_tooltip',
...
class GitHubTokenButton(UIButton):
    def __init__(self, master):
        fg_color = ThemeManager.theme['CTkEntry'].get('fg_color', None)
        super().__init__(
            text=str(L('launcher_settings_github_token_create_button', 'Create...')),
        ...
        self.set_tooltip(str(L('launcher_settings_github_token_create_tooltip', 'Open **GitHub Personal Access Token** creation webpage.')))


class VerifySSLCheckbox(UICheckbox):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_verify_ssl_checkbox', 'Verify SSL')),
            variable=Vars.Launcher.verify_ssl,
            master=master)
        self.set_tooltip(str(L('launcher_settings_verify_ssl_tooltip',
...
class ProxyEnableCheckbox(UICheckbox):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_proxy_enable_checkbox', 'Use Proxy:')),
            font=('Microsoft YaHei', 14, 'bold'),
            variable=Vars.Launcher.proxy.enable,
            master=master)
        self.set_tooltip(str(L('launcher_settings_proxy_enable_tooltip',
...
class ProxyTypeLabel(UILabel):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_proxy_type_label', 'Type:')),
            font=('Microsoft YaHei', 14),
            fg_color='transparent',
            master=master)
...
class ProxyTypeOptionMenu(UIOptionMenu):
    def __init__(self, master):
        super().__init__(
            ...
            dropdown_font=('Arial', 14),
            master=master)
        self.set_tooltip(str(L('launcher_settings_proxy_type_tooltip',
...
class ProxyDNSViaSocks5Checkbox(UICheckbox):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_proxy_dns_checkbox', 'Proxy DNS Via SOCKS5')),
            variable=Vars.Launcher.proxy.proxy_dns_via_socks5,
            master=master)
        self.set_tooltip(str(L('launcher_settings_proxy_dns_tooltip',
...
class ProxyHostLabel(UILabel):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_proxy_host_label', 'Host:')),
            font=('Microsoft YaHei', 14),
            fg_color='transparent',
            master=master)
...
class ProxyHostEntry(UIEntry):
    def __init__(self, master):
        super().__init__(
            ...
            font=('Arial', 14),
            master=master)
        self.set_tooltip(str(L('launcher_settings_proxy_host_tooltip', 'Proxy IP address (i.e. `123.12.1.231`) or domain name (i.e. `proxyprovider.com`).')))
...
class ProxyPortLabel(UILabel):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_proxy_port_label', 'Port:')),
            font=('Microsoft YaHei', 14),
            fg_color='transparent',
            master=master)
...
class ProxyPortEntry(UIEntry):
    def __init__(self, master):
        super().__init__(
            ...
            font=('Arial', 14),
            master=master)
        self.set_tooltip(str(L('launcher_settings_proxy_port_tooltip', 'Proxy port (i.e. `1080`).')))
...
class ProxyUseCredentialsCheckbox(UICheckbox):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_proxy_credentials_checkbox', 'Proxy Requires Password')),
            variable=Vars.Launcher.proxy.use_credentials,
            master=master)
        self.set_tooltip(str(L('launcher_settings_proxy_credentials_tooltip',
...
class ProxyUserLabel(UILabel):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_proxy_user_label', 'User:')),
            font=('Microsoft YaHei', 14),
            fg_color='transparent',
            master=master)
...
class ProxyUserEntry(UIEntry):
    def __init__(self, master):
        super().__init__(
            ...
            font=('Arial', 14),
            master=master)
        self.set_tooltip(str(L('launcher_settings_proxy_user_tooltip', 'User name provided by your proxy service.')))


class ProxyPasswordLabel(UILabel):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_proxy_password_label', 'Password:')),
            font=('Microsoft YaHei', 14),
            fg_color='transparent',
            master=master)
...
class ProxyPasswordEntry(UIEntry):
    def __init__(self, master):
        super().__init__(
            ...
            font=('Arial', 14),
            master=master)
        self.set_tooltip(str(L('launcher_settings_proxy_password_tooltip', 'Password provided by your proxy service.')))


class LanguageLabel(UILabel):
    def __init__(self, master):
        super().__init__(
            text=str(L('launcher_settings_language_label', 'Language:')),
            font=('Microsoft YaHei', 14, 'bold'),
            fg_color='transparent',
            master=master)
...
class LanguageOptionMenu(UIOptionMenu):
    def __init__(self, master):
        super().__init__(
            values=['English', '中文'],
            variable=Vars.Launcher.language,
